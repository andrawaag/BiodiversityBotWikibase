...
main_url = "https://wildlife-sme.semscape.org"
mediawiki_api_url = main_url+"/w/api.php" # <- change to applicable wikibase
sparql_endpoint_url = main_url+"/query/sparql"  # <- change to applicable wikibase
